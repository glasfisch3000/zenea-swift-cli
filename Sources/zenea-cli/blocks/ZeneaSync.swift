...
public struct ZeneaSync: AsyncParsableCommand {
    ...
    public static var configuration: CommandConfiguration = .init(commandName: "sync", abstract: "Synchronise Zenea blocks between block sources.", usage: nil, discussion: "", version: "", shouldDisplay: true, subcommands: [], defaultSubcommand: nil, helpNames: nil)
