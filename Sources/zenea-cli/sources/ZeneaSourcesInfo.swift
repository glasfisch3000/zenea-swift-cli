...
public struct ZeneaSourcesInfo: AsyncParsableCommand {
    ...
    public static var configuration: CommandConfiguration = .init(commandName: "info", abstract: "Get information about a Zenea block source.", usage: "", discussion: "", version: "", shouldDisplay: true, subcommands: [], defaultSubcommand: nil, helpNames: nil)
